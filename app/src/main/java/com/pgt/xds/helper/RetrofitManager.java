package com.pgt.xds.helper;


import com.pgt.xds.utils.Constan;
import com.pgt.xds.api.XdsServiceApi;
import com.pgt.xds.app.MyApplication;
import com.pgt.xds.utils.NetUtil;
...
public class RetrofitManager {
    ...
    private final XdsServiceApi weatherServiceApi;

    public static RetrofitManager builder() {
        return new RetrofitManager();
    }

    public XdsServiceApi getService() {
    ...
    private RetrofitManager() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        weatherServiceApi = retrofit.create(XdsServiceApi.class);
